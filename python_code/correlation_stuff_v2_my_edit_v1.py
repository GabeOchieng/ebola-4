...
file_loc="/home/alexander/ebola/Source_data.xlsx" # identify xls file
...
for row in range (max_row):
    arr[row][0]=data.cell_value(row,2)
for row in range (max_row):
    arr[row][1]=data.cell_value(row,7)
for row in range (max_row):
    arr[row][2]=data.cell_value(row,8)
for row in range(max_row):
    for col in range(3):
        print arr[row][col]
